...
- **Workflow 8 (Net Worth Calculation with Negative Loan Liability)**: Verifies multi-account net worth aggregation across Checking ($1,000.00) + Savings ($2,000.00) + Credit Card ($0.00) - Auto Loan ($15,000.00 negative liability) + Investment ($5,000.00) = -$7,000.00. Confirms that loan accounts are strictly treated as negative liabilities that reduce total net worth.
