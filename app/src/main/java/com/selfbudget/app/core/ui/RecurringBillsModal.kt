        ...
        Surface(
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                TopAppBar(
                    ...
                    actions = {
                        NeutralBadge(text = "${activeBills.size} active")
                    ...
                    if (activeBills.isEmpty()) {
                        Surface(
                            ...
                            Column(
                                ...
                                Text(
                                    text = "Add fixed commitments like rent, utilities, and memberships to safeguard your monthly budget.",
                        ...
                        SectionHeaderBand(
                            title = "Committed Bills & Subscriptions",
                            ramp = Ramp.Coral,
                            icon = Icons.Default.ArrowUpward,
                            countPill = "$currencySymbol%,.0f/mo".format(totalMonthlyExpense)
                        ) {
                            activeBills.forEachIndexed { index, item ->
